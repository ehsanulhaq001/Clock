...
function draw() {
  ...
  ctx.lineTo(
    cnv.width / 2 + 160 * Math.sin(houAng),
    cnv.height / 2 - 160 * Math.cos(houAng)
  );
  ctx.strokeStyle = "rgb(150, 255, 100)";
  ctx.stroke();
  ctx.beginPath();
  ...
  ctx.arc(
    cnv.width / 2 + 200 * Math.sin(houAng),
    cnv.height / 2 - 200 * Math.cos(houAng),
    12,
    0,
    2 * Math.PI,
    true
  ...
  ctx.moveTo(cnv.width / 2, cnv.height / 2);
  ctx.lineTo(
    cnv.width / 2 + 180 * Math.sin(minAng),
    cnv.height / 2 - 180 * Math.cos(minAng)
  );
  ctx.strokeStyle = "rgb(150, 100 ,255)";
  ctx.stroke();
  ctx.beginPath();
  ...
  ctx.arc(
    cnv.width / 2 + 200 * Math.sin(minAng),
    cnv.height / 2 - 200 * Math.cos(minAng),
    5,
    0,
    2 * Math.PI,
    true
  ...
  ctx.moveTo(cnv.width / 2, cnv.height / 2);
  ctx.lineTo(
    cnv.width / 2 + 220 * Math.sin(secAng),
    cnv.height / 2 - 220 * Math.cos(secAng)
  );
  ctx.strokeStyle = "rgb(255, 100 ,150)";
  ctx.stroke();
  ctx.beginPath();
